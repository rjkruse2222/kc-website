...
export const metadata: Metadata = {
  title: 'Our Services | Kruse & Crawford CPAs',
...
/**
 * CONCEPT 4: "Lifecycle Focus"
 *
 * Design Direction:
 * - Built on V3 warm style
 * - Hero features the services lifecycle diagram prominently
 * - Emphasizes the year-round partnership approach
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 py-20 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-full max-w-xl bg-white rounded-3xl p-6 shadow-2xl">
                <Image
