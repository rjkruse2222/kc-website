      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex justify-center items-center space-x-6 mb-12">
          <a
            ...
            className="w-14 h-14 flex items-center justify-center bg-white/10 backdrop-blur-sm rounded-full text-white hover:bg-[#9bd9e4] hover:text-[#003067] focus:outline-none focus:ring-2 focus:ring-[#9bd9e4] focus:ring-offset-2 focus:ring-offset-[#003067] transition-all duration-300 border border-white/20 transform hover:-translate-y-1 hover:shadow-xl"
        ...
        <div className="max-w-xl mx-auto bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          <h3 className="text-white text-xl font-semibold mb-3" id="newsletter-heading">Stay Informed</h3>
          <p className="text-white/90 text-sm mb-6" id="newsletter-description">Get the latest insights and updates delivered to your inbox</p>
          <form className="flex flex-col sm:flex-row gap-3" aria-labelledby="newsletter-heading" aria-describedby="newsletter-description">
            ...
            <input
              ...
              required
              aria-required="true"
              className="flex-1 px-5 py-3 rounded-lg text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#9bd9e4] focus:ring-offset-2"
            />
            <button
              type="submit"
              className="px-8 py-3 bg-[#9bd9e4] text-[#003067] font-semibold rounded-lg hover:bg-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#003067] transform hover:-translate-y-0.5 transition-all duration-300 shadow-lg uppercase text-sm tracking-wide"
            >
              Subscribe
            </button>
          </form>
